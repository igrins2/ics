...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.bt_start.setText(QCoreApplication.translate("Dialog", u"email sending: Start / Stop", None))
